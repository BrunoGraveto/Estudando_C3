...
int verificaAVL(ArvAVL *raiz) {
    ...
    int alturaEsquerda = altura_NO((*raiz)->esq);
    int alturaDireita = altura_NO((*raiz)->dir);
    ...
    int esquerdaEhAVL = verificaAVL(esq);
    int direitaEhAVL = verificaAVL(dir);

    return esquerdaEhAVL && direitaEhAVL;
}
